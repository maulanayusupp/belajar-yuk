...
| `pages/materi`     | Daftar Materi (daftar isi semua pelajaran + Coding, dikelompokkan per kategori usia)                                                                                                      | `lessonService.getLessonsGrouped` + `codingService`; progres per baris. Otomatis ikut saat materi ditambah                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
